...
import de.yfu.intranet.methods.api.resources.mapper.SeminarMapper;
import de.yfu.intranet.methods.data.domain.SeminarGoal;
import de.yfu.intranet.methods.data.domain.SeminarType;
import de.yfu.intranet.methods.service.SeminarService;
...
@RestController
@RequestMapping(value = SeminarController.SEMINAR_ENDPOINT)
